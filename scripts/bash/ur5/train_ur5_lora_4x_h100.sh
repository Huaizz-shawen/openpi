...
CONFIG_NAME="pi05_ur5e_tabletop_3obj_frontleft_lora_local"
EXP_NAME="ur5e_tabletop_frontleft_40k_lora_4xh100"
...
echo "Starting LoRA training with $CONFIG_NAME on $DATASET_PATH ..."

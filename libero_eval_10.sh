...
# Server log
SERVER_LOG="policy_server_10.log"
...
echo "Starting Libero evaluation (10)..."
...
# Run Libero client
# Running libero_10 task suite
export MUJOCO_GL=egl
export LIBGL_DRIVERS_PATH=/usr/lib/x86_64-linux-gnu/dri
export LD_PRELOAD=/usr/lib/x86_64-linux-gnu/libstdc++.so.6

python examples/libero/main.py --args.task-suite-name libero_10 --args.host 127.0.0.1

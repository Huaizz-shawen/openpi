...
.venv/bin/python scripts/train.py $CONFIG_NAME --exp_name $EXP_NAME --overwrite --num_workers 0 --data.repo_id $DATASET_PATH --fsdp_devices 1 --num_train_steps 50

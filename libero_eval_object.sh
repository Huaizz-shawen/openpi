...
# Server log
SERVER_LOG="policy_server_object.log"
...
echo "Starting Libero evaluation (Object)..."
...
# Run Libero client
# Running libero_object task suite
# Use MUJOCO_GL=egl for headless rendering
export MUJOCO_GL=egl
export LIBGL_DRIVERS_PATH=/usr/lib/x86_64-linux-gnu/dri
export LD_PRELOAD=/usr/lib/x86_64-linux-gnu/libstdc++.so.6

python examples/libero/main.py --args.task-suite-name libero_object --args.host 127.0.0.1
